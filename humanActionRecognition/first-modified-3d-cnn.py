...
CHECKPOINT_PATH = "checkpoints/ours_2_10epochs"
...
def get_model():
    ...
    kernel_initializer='he_uniform', input_shape=(10, 240, 320, 3),padding ="same"))
...
def main():
    ...
    model.save('models/ours_2_10epochs_model')
    compressed_pickle('history/ours_2_10epochs.pickle', history.history)
